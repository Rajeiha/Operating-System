;Rajeiha --- The Rajeiha Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE RajeihaOS_VER '1.0.0'	 ;OS version number
	%DEFINE RajeihaOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as RajeihaOS and its programs
...
option_screen:
	...
	os_init_msg		db '********************Welcome to Rajeiha Operating System***********************', 0
	os_version_msg		db 'Version ', RajeihaOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', RajeihaOS_VER, 0

	dialog_string_1		db 'Welcome to Rajeiha Operating System', 0
